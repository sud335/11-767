...
def classifier():
    ...
    ## model loaded till here
    
    while True:
#         print("buffer B1" ,b1, b1.full, b1.index)
#         print("buffer B2" ,b2, b2.full, b2.index)
...
#         clf = RandomForestClassifier(max_depth=5, n_estimators=14, max_features=1)
        ...
        if b1.full and b2.full:
            ...
            x=[]
            print(b1, b2)
            emotion = b1.storage[-1]
            activity = b2.storage[-1]
            
            print("activity,emotion",activity,emotion)
